...
rm -rf /opt/entorepo/apps/picard/3.0.0 >& /dev/null

mkdir -p /opt/entorepo/apps/picard/3.0.0
cp -r * /opt/entorepo/apps/picard/3.0.0
cd /opt/entorepo/apps/picard
rm current >& /dev/null
ln -sTf 3.0.0 current
