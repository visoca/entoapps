...
# 24/11/2016
#	- Changed version of bcftools from 1.2 to 1.3.1
#	- Added option to add header to output file (useful for using it with PCA_genotypes.R)
# 29/07/2019 1.41
# Changed version of bcftools from 1.3.1 to 1.9
...
if ($header==1){
	print OUT "variant\tref\talt\t".join("\t",@ids)."\n";
}
...
sub usage{
	...
	print "      -a add header to output file\n";
