...
# Last modified: 25/10/2022 16:31:10
...
# 1.5.3 - 25/10/2022 - Updated paths to bcftools and estpEM
#
...
my $version='1.5.3-2022.10.25';

# Path to external programs
# my $bcftools='/usr/local/extras/Genomics/apps/bcftools/1.5/bin/bcftools';
# my $estpEM='/usr/local/extras/Genomics/apps/estpEM/2014-10-08/bin/estpEM'; # program for estimating AFs by ML
