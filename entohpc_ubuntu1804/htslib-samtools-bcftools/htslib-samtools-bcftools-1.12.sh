...
# htslib
# --------------------------------------------------------------
rm -rf htslib-1.12 htslib-1.12.tar.bz2 >& /dev/null

wget https://github.com/samtools/htslib/releases/download/1.12/htslib-1.12.tar.bz2
tar -xf htslib-1.12.tar.bz2
cd htslib-1.12
./configure \
--prefix=/opt/entorepo/lib/htslib/1.12
make -j12
rm -rf /opt/entorepo/lib/htslib/1.12 >& /dev/null
make install
...
# samtools
# --------------------------------------------------------------
rm -rf samtools-1.12 samtools-1.12.tar.bz2 >& /dev/null
...
./configure \
--prefix=/opt/entorepo/apps/samtools/1.12 \
--with-htslib=/opt/entorepo/lib/htslib/1.12
make
rm -rf /opt/entorepo/apps/samtools/1.12 >& /dev/null
make install
...
# bcftools
# --------------------------------------------------------------
rm -rf bcftools-1.12 bcftools-1.12.tar.bz2 >& /dev/null

wget https://github.com/samtools/bcftools/releases/download/1.12/bcftools-1.12.tar.bz2
tar -xf bcftools-1.12.tar.bz2
cd bcftools-1.12
./configure \
--prefix=/opt/entorepo/apps/bcftools/1.12 \
--with-htslib=/opt/entorepo/lib/htslib/1.12 
make
rm -rf /opt/entorepo/apps/bcftools/1.12 >& /dev/null
make install
...
perl -pi -e 's/\#\!\/usr\/bin\/perl \-w/\#\!\/usr\/bin\/env perl/g' /opt/entorepo/apps/bcftools/1.12/bin/vcfutils.pl
perl -pi -e 's/\#\!\/usr\/bin\/python/\#\!\/usr\/bin\/env python/g' /opt/entorepo/apps/bcftools/1.12/bin/plot-roh.py
...
cd $CURRDIR
rm -rf bcftools-1.12 bcftools-1.12.tar.bz2
# --------------------------------------------------------------
